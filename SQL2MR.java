...
public class SQL2MR {
  ...
  if (price >= 10000) {outputKey.set(carbodyTok);outputValue.set(mpg);
context.write(outputKey, outputValue);}
  ...
  public static class IntSumReducer 
	...
	// fill in your code here!!!
      int cnt = 0;
      int max_mpg = 0;
      for (IntWritable val : values) {cnt += 1;
          max_mpg = Math.max(max_mpg, val.get());}
      if (cnt >= 5) {result.set(max_mpg);}
